#!/usr/bin/env python3
"""Run a pinned PARSeq recognizer on word crops and report OCR metrics."""
...
def find_parseq_checkpoint() -> Path | None:
...
def maybe_log_wandb(args, summary: dict) -> str | None:
    ...
    run = wandb.init(
        ...
        tags=["ocr", "parseq", "smoke", "teacher-lock"],
        config={
...
def main() -> int:
    ...
    checkpoint = find_parseq_checkpoint()
