# eval300_actual_assignment_failure_bank_2026_06_26
...
- Shortlist Tesseract delta vs nearest: `-20`
- Shortlist vs current delta: `-12`
- Current categories: `{'correct_nearest': 57, 'exact_oracle_change': 4, 'false_change': 1, 'missed_oracle': 13}`
- Shortlist categories: `{'correct_nearest': 58, 'exact_oracle_change': 15, 'missed_oracle': 2}`
- Next-model targets: `{'improve_first_stage_shortlist_recall': 2, 'keep_current_good_change': 4, 'keep_noop': 57, 'recover_shortlist_oracle_change': 11, 'reject_current_bad_change': 1}`
- Oracle rank by target: `{'improve_first_stage_shortlist_recall': {'0': 2}, 'keep_current_good_change': {'1': 2, '2': 1, '3': 1}, 'keep_noop': {'0': 57}, 'recover_shortlist_oracle_change': {'1': 4, '2': 3, '3': 1, '6': 2, '7': 1}, 'reject_current_bad_change': {'0': 1}}`
...
| key | source | ref | nearest -> current -> shortlist | deltas current/shortlist/vs-current | codes nearest/current/shortlist/oracle | rank oracle |
|---|---|---|---|---:|---|---:|
| 1/12/1 | iam_words | `Lawrence` | `Be aanenien cp:` -> `Be aanenien cp:` -> `Be aanenien cp:` | 0/0/0 | 2/2/2/49 | 0 |
| 2/69/1 | icdar2013 | `COSTA` | `<Q. WA` -> `<Q. WA` -> `<Q. WA` | 0/0/0 | 1/1/1/25 | 0 |
