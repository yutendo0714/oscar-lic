# eval300_actual_assignment_failure_feature_audit_2026_06_26
...
| recover_shortlist_oracle_change | `tabular_imgdiff` | 0.0027904513901775545 | 5.454545454545454 | 0 | 0 | 5 |
...
| improve_first_stage_shortlist_recall | `codeonly` | null | null | 0 | 0 | 0 |
| improve_first_stage_shortlist_recall | `diffcrop` | null | null | 0 | 0 | 0 |
| improve_first_stage_shortlist_recall | `latentwindow` | null | null | 0 | 0 | 0 |
| improve_first_stage_shortlist_recall | `latentctx` | null | null | 0 | 0 | 0 |
| improve_first_stage_shortlist_recall | `tabular_imgdiff` | 6.234692055331073e-07 | 5.0 | 0 | 0 | 0 |
...
|---|---:|---|---:|---:|---:|
| recover_shortlist_oracle_change | 11 | `topk_rank` | 2.909090909090909 | 1.0 | 7.0 |
| recover_shortlist_oracle_change | 11 | `assignment_relative_error` | 1.112368876283819 | 1.0119526386260986 | 1.333662509918213 |
| recover_shortlist_oracle_change | 11 | `codebook_delta_l2` | 0.8758733435110613 | 0.6486960053443909 | 1.3729530572891235 |
| recover_shortlist_oracle_change | 11 | `codebook_code_nearest_cosine` | 0.5370248136195269 | 0.11197589337825775 | 0.6853041052818298 |
...
| recover_shortlist_oracle_change | 11 | `img_source_variant_mse` | 0.00025365977886725557 | 0.00014412276505026966 | 0.0003129505494143814 |
...
| improve_first_stage_shortlist_recall | 2 | `topk_rank` | 6.0 | 6.0 | 6.0 |
| improve_first_stage_shortlist_recall | 2 | `assignment_relative_error` | 1.1391233801841736 | 1.1204224824905396 | 1.1578242778778076 |
| improve_first_stage_shortlist_recall | 2 | `codebook_delta_l2` | 0.8901267647743225 | 0.8475155830383301 | 0.9327379465103149 |
| improve_first_stage_shortlist_recall | 2 | `codebook_code_nearest_cosine` | 0.599086582660675 | 0.5922940373420715 | 0.6058791279792786 |
...
| improve_first_stage_shortlist_recall | 2 | `img_source_variant_mse` | 0.00023885822156444192 | 0.00021392814232967794 | 0.0002637883007992059 |
...
| improve_first_stage_shortlist_recall | 1/12/1 | iam_words | `Lawrence` | oracle_missing | 2/2/2/49 | 0/0/0 | 0.9999980926513672 | None/null | None/null | None/null | None/null | 2.087778613172914e-07/5 |
| improve_first_stage_shortlist_recall | 2/69/1 | icdar2013 | `COSTA` | oracle_missing | 1/1/1/25 | 0/0/0 | 0.004869639873504639 | None/null | None/null | None/null | None/null | 1.0381605497489232e-06/5 |
...
- recover_shortlist_oracle_change: `experiments/figures/eval300_actual_assignment_failure_feature_audit_2026_06_26/recover_shortlist_oracle_change.png`
- reject_current_bad_change: `experiments/figures/eval300_actual_assignment_failure_feature_audit_2026_06_26/reject_current_bad_change.png`
- improve_first_stage_shortlist_recall: `experiments/figures/eval300_actual_assignment_failure_feature_audit_2026_06_26/improve_first_stage_shortlist_recall.png`
- keep_current_good_change: `experiments/figures/eval300_actual_assignment_failure_feature_audit_2026_06_26/keep_current_good_change.png`
